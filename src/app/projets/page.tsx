    ...
    <div className="text-gray-800 mt-20">
      ...
      <div className="max-w-5xl mx-auto p-8 space-y-8">
        <div className="space-y-4">
          <h1 className="text-lg font-bold text-gray-800 titre">Le Défi</h1>
        ...
        <div className="space-y-4">
          <h1 className="text-lg font-bold text-gray-800 titre">Notre Réponse</h1>
          <p className="text-lg leading-relaxed">
        ...
        <div className="space-y-4 mt-12">
          <h1 className="text-lg font-bold text-gray-800 titre">Le Résultat</h1>
          <p className="text-lg leading-relaxed">
