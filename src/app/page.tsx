...
export default function Home() {
      ...
      <section className="relative h-full min-h-screen overflow-hidden">
        ...
        <div className="relative grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 min-h-screen z-10">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-[#fff]">
            ...
            <a
              href="/contact"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border border-gray-300 rounded-lg hover:bg-[#feab73] duration-300 focus:ring-4 focus:ring-gray-100"
            >
              Contactez-Nous
            </a>
          </div>
  ...
  <div className="text-center px-4">
    ...
    <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8 md:mb-12 mx-auto max-w-3xl">
      ...
      <section className="container mx-auto w-full py-16 px-8" id="services">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          {[
            ...
            <div
              key={index}
              className="border rounded-lg border-black p-6 bg-white hover:bg-gray-100 transition duration-300 transform hover:-translate-y-2 hover:shadow-xl w-full md:w-1/4"
            >
              <div>
      ...
      <section className="relative bg-fixed bg-center bg-cover whatsap-img my-20">
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative z-10 w-full h-full max-w-screen-xl mx-auto px-4 py-8 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16">
